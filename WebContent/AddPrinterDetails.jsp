...
try
{
	...
	String qry1 = "INSERT INTO `PRODUCT` (`PID`,`PTYPE`, `PNAME`, `PPRICE`, `DESCRIPTION`, `PQUANTITY`) VALUES ('"+PID+"','Computer','"+PName+"', '"+PPrice+"', '"+PDesc+"', '"+PQuant+"');";
	
	st.executeUpdate(qry1);
	
	
	String qry2 = "INSERT INTO `PRINTER` (`PID`, `PrinterType`, `Resolution`) VALUES ('"+PID+"', '"+PrinterType+"', '"+Resolution+"');";
